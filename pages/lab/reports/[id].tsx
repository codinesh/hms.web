  ...
  return (
    <div>
      ...
      <div className='bg-white shadow overflow-hidden sm:rounded-lg'>
        <div className='px-4 py-5 sm:px-6'>
          <h3 className='text-lg leading-6 font-medium text-gray-900'>
            Lab tests {JSON.stringify(testResultsState)}
          </h3>
            ...
            {labInvoice.invoiceDetail.map((test) => {
              return (
                <div className='flex items-center pr-4'>
                  <div className='flex-grow py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                    <dt className='text-sm font-medium text-gray-500'>
                      {test.testName}
                    </dt>
                    <dd className='mt-1 divide-y  text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
                      {test.labTestRecord.labTestResult.map((x) => {
                        ...
                        return (
                          <dl className='sm:divide-y sm:divide-gray-200'>
                            <div className=' py-4 bg-red-100 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                              <dt className='text-sm font-medium text-gray-500'>
                                {x.referenceRange}
                              </dt>
                              <dd className='bg-red-100 mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
                                <input
                                  type='text'
                                  value={testResult}
                                  onChange={(e) => {
