        ...
        <div className='absolute inset-0 overflow-hidden'>
          ...
          <div className='fixed inset-y-0 right-0 pl-10 max-w-full flex sm:pl-16'>
            <Transition.Child
              ...
              <div className='w-screen max-w-2xl overflow-scroll'>
                          ...
                          <div className='space-x-3 flex justify-between items-center'>
                            ...
                            <div className='flex gap-2'>
                              ...
                              <button
                                ...
                                className={clsx('text-center inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none ', isEdit ? 'bg-gray-300' : 'bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500')}>
                                {loading && (
                                  <svg
